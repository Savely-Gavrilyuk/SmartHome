...
#define carta 0xF9BB6DE4       //ID карты
...
void loop() 
{
  ...
  switch (ID)                                     //Сравниваем ID с имеющимеся значениями ID
  {                                               
    case carta:                                   //Если ID совподает со ID карты
      ...
      break;                                      
    case brelok:                                  //Если ID совподает со ID брелка
